  ...
  return (
    <>
      ...
      <Box
        ...
        sx={{
          width: {
            sm: !["/", "/login", "/signup"].includes(location.pathname)
      ...
      >
        ...
        {user && (
          <Switch>
            ...
            <Route path="/createauction" exact>
              <FarmerForm username={username} user={user}></FarmerForm>
            </Route>
            <Route path="/profile" exact>
              <ProfilePage user={user}></ProfilePage>
            </Route>
            <Route path="/suggest" exact>
              <SuggestionPage user={user}></SuggestionPage>
            </Route>
...
function NoMatch() {
  ...
  return (
    <Container>
      ...
      <Button component={Link} variant="text" color="info" to="/">
        Back Home
      </Button>
    </Container>
  );
