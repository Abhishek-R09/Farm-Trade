...
const SuggestionPage = ({ user }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    axios
      .post("https://mlagrohelp-xipqzrlqna-el.a.run.app/crop", suggestion, {
        headers: {
  ...
  return loading ? (
    ...
    <div
      className="container"
      style={{ border: "1.5px solid black", marginTop: "15vh" }}
    >
      <div className="row">
            ...
            <div className="card-body">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="form-group p-2">
                    <label style={{ color: "darkblue" }}>
                      <i className="fas fa-leaf"></i>N (Nitrogen)
                    </label>
                    <input
                      type="number"
                      className="form-control"
                ...
                <div className="col-md-6">
                  <div className="form-group p-2">
                    <label style={{ color: "darkblue" }}>
                      <i className="fas fa-leaf"></i>P (Phosphorus)
                    </label>
                    <input
                      type="number"
                      className="form-control"
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group p-2">
                    <label style={{ color: "darkblue" }}>
                      <i className="fas fa-leaf"></i>K (Potassium)
                    </label>
                    <input
                      type="number"
                      className="form-control"
